...
export default function Home() {
  ...
  return (
    <div className="flex flex-col ">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-[#f1df96] to-[#e4b53b] flex flex-col justify-center lg:flex-row items-center py-12 px-6 md:px-12">
        {/* Contenedor de Texto */}
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <h1 className="text-5xl font-bold leading-tight text-[#6d381a]">
            <span className="block text-[#e4b53b]">El futuro</span>
            <span className="block text-[#d98b5d]">del talento</span>
            <span className="block text-[#6d381a]">humano está aquí</span>
          </h1>
          <p className="text-lg text-[#6d381a]/80 md:text-xl">
        ...
        {/* Imagen con Estilo Curvo */}
        <motion.div
          className="relative mt-12 lg:mt-0 lg:ml-12 w-full max-w-md lg:max-w-lg"
        ...
        >
          <Image
            ...
            className="rounded-lg object-cover shadow-xl hover:shadow-2xl transition-shadow duration-500 w-full clip-ellipse border-4 border-[#6d381a]"
            priority
          />
        </motion.div>
      </section>
